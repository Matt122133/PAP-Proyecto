...
public interface IControladorAltaDictadoDeClase {
	...
	public void altaDictadoClase(String nombreInst, String nombreAct, String nombreProf, String nombre, Calendar fecha, int horaIni, String url, Calendar fechaReg) throws ClaseRepetidaException;
