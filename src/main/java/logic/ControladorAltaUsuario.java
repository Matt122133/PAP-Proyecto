...
public class ControladorAltaUsuario implements IControladorAltaUsuario {
	...
	public void altaUsuario(DtUsuario usuario) throws UsuarioRepetidoException {
		...
		if (nuevoUsuario != null) 
			throw new UsuarioRepetidoException("El usuario " + usuario.getNickname() + " ya esta registrado.");
			//throw new UsuarioRepetidoException("El usuario con el email " + usuario.getEmail() + "ya esta registrado");
